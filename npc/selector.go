...
type selectorSpec struct {
	...
	policyTypes []policyType    // TODO(brb) rephrase: netpol types (egress, ingress or both) which initiated the target selector; also, if policyType is set, then it's treated as
	// a target selector.
